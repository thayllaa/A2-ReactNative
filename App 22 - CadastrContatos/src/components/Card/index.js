...
function Card({ data, funcLoadContatos }) {
  ...
  async function verForm() {
    navigation.navigate('Formulario', {
      ...
      atualizarLista: funcLoadContatos,
    });
  }
    ...
    <View>
      <View style={styles.card}>
        ...
        <View style={styles.btnArea}>
          ...
          <TouchableOpacity style={styles.buttonExcluir} onPress={excluirContato}>
